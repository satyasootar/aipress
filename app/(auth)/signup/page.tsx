    ...
    <div className="w-full flex min-h-screen bg-black">
      ...
      <div className="hidden lg:block lg:w-1/2 relative bg-zinc-900 border-r border-solid-faint">
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-12 text-white">
          <h2 className="font-serif text-5xl mb-4 leading-tight">Start reading today.</h2>
          <p className="font-sans text-gray-400 max-w-md">
            Create an account to save your favorite articles, leave comments, and join a community of curious minds.
          </p>
        </div>
      </div>
