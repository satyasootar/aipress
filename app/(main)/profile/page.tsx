      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-1">
          <div className="border border-white/10 p-6 bg-zinc-900/50">
            ...
            <div className="flex flex-col gap-3 font-sans text-sm text-gray-400 border-t border-dashed-faint pt-4">
              ...
              {user.likes.length === 0 ? (
                ...
                user.likes.map(like => (
                  <div key={like.id} className="flex flex-col border-b border-dashed-faint pb-3 last:border-0">
                    ...
                    <span className="text-xs font-sans text-gray-500 uppercase tracking-widest">Liked on {new Date(like.createdAt).toLocaleDateString()}</span>
                  </div>
                ))
              )}
            </div>
